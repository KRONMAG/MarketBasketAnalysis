...
namespace MarketBasketAnalysis.AssociationRuleAnalysis.Contracts
{
    /// <summary>
    ...
    public sealed class MaximalCliqueFindingParameters
    {
        ...
        /// Thrown if <paramref name="minCliqueSize"/> is less than two,
        ...
        public MaximalCliqueFindingParameters(int minCliqueSize, int maxCliqueSize, bool ignoreOneWayLinks = false)
        {
            if (minCliqueSize < 2)
            {
                throw new ArgumentOutOfRangeException(
                    ...
                    minCliqueSize,
                    "Minimum clique size must be greater or equal to two.");
            }
