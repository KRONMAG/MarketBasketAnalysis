...
{
    internal sealed class SearchForFrequentItemsStep : ISearchForFrequentItemsStep
    {
        #region Nested Types
...
#pragma warning restore SA1313 // Parameter names should begin with lower-case letter
        ...
        #region Constructors
        internal SearchForFrequentItemsStep(
            ItemExcluderFactory itemExcluderFactory,
        ...
        #region Methods
        public SearchForFrequentItemsResult Run(
            ...
            CancellationToken cancellationToken)
        {
            ...
            {
                return SearchForFrequentItemsResult.Empty;
            }
